...
/**
 * Implementation of a {@link HystrixMetricsPublisher} for Prometheus Metrics. See <a
...
public class HystrixPrometheusMetricsPublisher extends HystrixMetricsPublisher {
    ...
    /**
     * Register an instance of this publisher, without a namespace, with the {@link
     * com.netflix.hystrix.strategy.HystrixPlugins} singleton. The publisher registered by this method will register
     * metrics with the default CollectorRegistry and will NOT attempt to export properties.
     *
    ...
    /**
     * Register an instance of this publisher, without a namespace, with the {@link
     * com.netflix.hystrix.strategy.HystrixPlugins} singleton. The publisher registered by this method will NOT attempt
    ...
    /**
     * Register an instance of this publisher, for the given namespace, with the {@link
     * com.netflix.hystrix.strategy.HystrixPlugins} singleton. The publisher registered by this method will register
     * metrics with the default CollectorRegistry and will NOT attempt to export properties.
     *
     * @see CollectorRegistry#defaultRegistry
    ...
    /**
     * Register an instance of this publisher, for the given namespace, with the {@link
     * com.netflix.hystrix.strategy.HystrixPlugins} singleton.
     */
